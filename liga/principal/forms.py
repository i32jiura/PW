...
class Fichajes(forms.Form):
	jugadorComprado = forms.CharField(max_length=50, label='Nombre Jugador que Compra')
	precio = forms.IntegerField()
	jugadorVendemos = forms.CharField(max_length=50, label='Nombre Jugador que Cambia')
